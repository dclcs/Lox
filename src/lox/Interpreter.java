...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void>{
    ...
    Interpreter() {
        globals.defines("clock", new LoxCallable() {
            @Override
            public int arity() {
                return 0;
            }
    ...
    public Void visitVarStmt(Stmt.Var stmt) {
        ...
        environment.defines(stmt.name.lexeme, value);
        return null;
    }
    ...
    public Void visitFunctionStmt(Stmt.Function stmt) {
        ...
        environment.defines(stmt.name.lexeme, function);
        return null;
    }
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        ...
        environment.defines(stmt.name.lexeme, null);

        if (stmt.superclass != null) {
            environment = new Environment(environment);
            environment.defines("super", superclass);
        }
